...
public class BotConstant {
    ...
    public static final String ALERT_NEW_SHIFT_EMAIL_TEMPLATE =
        "<div>%s Your %s manager just published a new%s shift for you: <br/><br/>%s</div>";

    public static final String ALERT_NEW_SHIFTS_EMAIL_TEMPLATE =
        "<div>%s Your %s manager just published %d new shifts that you are working: <br/><br/>%s</div>";

    public static final String ALERT_REMOVED_SHIFT_EMAIL_TEMPLATE =
        "<div>%s Your %s manager just removed you from a shift, so you are no longer working on it. Here is your new schedule: <br/><br/>%s</div>";

    public static final String ALERT_REMOVED_SHIFTS_EMAIL_TEMPLATE =
        "<div>%s Your %s manager just removed %d of your shifts so you are no longer working on it. <br/><br/> Your new shifts are: <br/><br/>%s</div>";

    public static final String ALERT_CHANGED_SHIFT_EMAIL_TEMPLATE =
        "<div>%s Your %s manager just changed your shift: <br/><br/>Old: %s<br/><br/>New:%s</div>";
